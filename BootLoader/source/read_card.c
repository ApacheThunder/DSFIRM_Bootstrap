...
void decryptSecureArea (u32 gameCode, u32* secureArea, int iCardDevice)
{
...
static void switchToTwlBlowfish(tNDSHeaderExt* ndsHeader) {
...
{
	tNDSHeaderExt* ndsHeader = (tNDSHeaderExt*)headerData;
